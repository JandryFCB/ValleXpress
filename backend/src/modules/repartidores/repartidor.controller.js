...
const Vendedor = require('../vendedores/vendedor.model');
const Pedido = require('../pedidos/pedido.model');
const Notificacion = require('../notificaciones/notificacion.model');
  ...
  async pedidosVista(req, res) {
    try {
      const pedidos = await Pedido.findAll({
        ...
        include: [
          {
            model: require('../vendedores/vendedor.model'),
            as: 'vendedor',
            attributes: ['id', 'nombreNegocio']
          },
          {
            model: require('../auth/usuario.model'),
            as: 'cliente',
    ...
    try {
      ...
      const pedidos = await Pedido.findAll({
        ...
        include: [
          ...
          {
            model: require('../direcciones/direccion.model'),
            as: 'direccionEntrega',
      ...
      const Direccion = require('../direcciones/direccion.model');
